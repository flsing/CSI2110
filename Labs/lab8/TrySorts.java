...
public class TrySorts extends Applet implements MouseListener, WindowListener {
  ...
  public boolean checkFields( String arraySizeText, 
                              String maxElementText ) {
    boolean result = true;
    try {
      int arraySize = Integer.parseInt(arraySizeText);
    }
    ...
    try {
      long maxElement = Long.parseLong(maxElementText);
    }
    catch (NumberFormatException e) {
   ...
   * @param numDigitsText java.lang.String
   * @param sortBoxChecked java.awt.Checkbox
   * @param radixBoxChecked java.awt.Checkbox
   */
  public boolean checkFields( String arraySizeText, 
                              String maxElementText, 
                              Checkbox sortBoxChecked
                              ) {
    boolean result = checkFields( arraySizeText, 
                                  maxElementText );
   ...
   */
  private boolean connEtoC1(java.awt.event.TextEvent arg1) {
  ...
  private void connEtoC2(java.awt.event.ActionEvent arg1) {
    try {
      this.doStartButton(getNumItemsField().getText(), 
                         getMaxElementField().getText(), 
                         getSortTypeGroup().getSelectedCheckbox(), 
                         getShowOutputBox().getState());
    } catch (java.lang.Throwable ivjExc) {
      handleException(ivjExc);
    }
  }
  ...
  private void connNew(java.awt.event.ActionEvent arg1) {
    try {
      this.doNewButton(getNumItemsField().getText(), 
                       getMaxElementField().getText() ); 
    } catch (java.lang.Throwable ivjExc) {
      handleException(ivjExc);
    }
   ...
   * @param size int
   */
  public String doBubbleSort(Long[] seq, int size) {
   ...
   * @param size int
   */
  public String doHeapSort(Long[] seq, int size) {
    java.util.Date timeIn = new java.util.Date( );
    new HeapSortInPlace<Long>( seq );
    java.util.Date timeOut = new java.util.Date( );
    long timeTaken = timeOut.getTime( ) - timeIn.getTime( );
    return Long.toString(timeTaken);
  }
   ...
   * @param size int
   */
  public String doQuickSort(Long[] seq, int size) {
    java.util.Date timeIn = new java.util.Date( );
    new QuickSortInPlace<Long>( seq );
  ...
  public void doNewButton( String arraySizeText, 
                           String maxElementText ) {
    int arraySize;
    long maxElement;
   ...
   * @param baseOption java.awt.Checkbox
   * @param printOutput boolean
   */
  public void doStartButton( String arraySizeText, 
                             String maxElementText, 
                             // String numDigitsText, 
                             Checkbox sortOption, 
                             // Checkbox baseOption, 
                             boolean printOutput ) {
    String timeTaken = "";
